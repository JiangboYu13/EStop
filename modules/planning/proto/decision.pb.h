...
inline bool MainStop_ChangeLaneType_Parse(
    const std::string& name, MainStop_ChangeLaneType* value) {
...
enum MainEmergencyStop_ReasonCode : int {
  MainEmergencyStop_ReasonCode_INTERNAL_ERR = 1,
  MainEmergencyStop_ReasonCode_COLLISION = 2,
  MainEmergencyStop_ReasonCode_ST_FIND_PATH = 3,
  MainEmergencyStop_ReasonCode_ST_MAKE_DECISION = 4,
  MainEmergencyStop_ReasonCode_SENSOR_ERROR = 5
};
bool MainEmergencyStop_ReasonCode_IsValid(int value);
constexpr MainEmergencyStop_ReasonCode MainEmergencyStop_ReasonCode_ReasonCode_MIN = MainEmergencyStop_ReasonCode_INTERNAL_ERR;
constexpr MainEmergencyStop_ReasonCode MainEmergencyStop_ReasonCode_ReasonCode_MAX = MainEmergencyStop_ReasonCode_SENSOR_ERROR;
...
enum MainCruise_ChangeLaneType : int {
  MainCruise_ChangeLaneType_FORWARD = 0,
  MainCruise_ChangeLaneType_LEFT = 1,
  MainCruise_ChangeLaneType_RIGHT = 2
};
bool MainCruise_ChangeLaneType_IsValid(int value);
constexpr MainCruise_ChangeLaneType MainCruise_ChangeLaneType_ChangeLaneType_MIN = MainCruise_ChangeLaneType_FORWARD;
constexpr MainCruise_ChangeLaneType MainCruise_ChangeLaneType_ChangeLaneType_MAX = MainCruise_ChangeLaneType_RIGHT;
constexpr int MainCruise_ChangeLaneType_ChangeLaneType_ARRAYSIZE = MainCruise_ChangeLaneType_ChangeLaneType_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* MainCruise_ChangeLaneType_descriptor();
template<typename T>
inline const std::string& MainCruise_ChangeLaneType_Name(T enum_t_value) {
  static_assert(::std::is_same<T, MainCruise_ChangeLaneType>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function MainCruise_ChangeLaneType_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    MainCruise_ChangeLaneType_descriptor(), enum_t_value);
}
inline bool MainCruise_ChangeLaneType_Parse(
    const std::string& name, MainCruise_ChangeLaneType* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<MainCruise_ChangeLaneType>(
    MainCruise_ChangeLaneType_descriptor(), name, value);
}
...
class MainStop :
 ...
 public:
  ...
  static inline bool ChangeLaneType_Parse(const std::string& name,
  ...
  ::apollo::planning::MainStop_ChangeLaneType change_lane_type() const;
  void set_change_lane_type(::apollo::planning::MainStop_ChangeLaneType value);
...
class MainEmergencyStop :
 ...
 public:
  ...
  static constexpr ReasonCode INTERNAL_ERR =
    MainEmergencyStop_ReasonCode_INTERNAL_ERR;
  static constexpr ReasonCode COLLISION =
    MainEmergencyStop_ReasonCode_COLLISION;
  static constexpr ReasonCode ST_FIND_PATH =
    MainEmergencyStop_ReasonCode_ST_FIND_PATH;
  static constexpr ReasonCode ST_MAKE_DECISION =
    MainEmergencyStop_ReasonCode_ST_MAKE_DECISION;
  static constexpr ReasonCode SENSOR_ERROR =
    MainEmergencyStop_ReasonCode_SENSOR_ERROR;
...
class MainCruise :
 ...
 public:
  ...
  typedef MainCruise_ChangeLaneType ChangeLaneType;
  static constexpr ChangeLaneType FORWARD =
    MainCruise_ChangeLaneType_FORWARD;
  static constexpr ChangeLaneType LEFT =
    MainCruise_ChangeLaneType_LEFT;
  static constexpr ChangeLaneType RIGHT =
    MainCruise_ChangeLaneType_RIGHT;
  static inline bool ChangeLaneType_IsValid(int value) {
    return MainCruise_ChangeLaneType_IsValid(value);
  }
  static constexpr ChangeLaneType ChangeLaneType_MIN =
    MainCruise_ChangeLaneType_ChangeLaneType_MIN;
  static constexpr ChangeLaneType ChangeLaneType_MAX =
    MainCruise_ChangeLaneType_ChangeLaneType_MAX;
  static constexpr int ChangeLaneType_ARRAYSIZE =
    MainCruise_ChangeLaneType_ChangeLaneType_ARRAYSIZE;
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor*
  ChangeLaneType_descriptor() {
    return MainCruise_ChangeLaneType_descriptor();
  }
  template<typename T>
  static inline const std::string& ChangeLaneType_Name(T enum_t_value) {
    static_assert(::std::is_same<T, ChangeLaneType>::value ||
      ::std::is_integral<T>::value,
      "Incorrect type passed to function ChangeLaneType_Name.");
    return MainCruise_ChangeLaneType_Name(enum_t_value);
  }
  static inline bool ChangeLaneType_Parse(const std::string& name,
      ChangeLaneType* value) {
    return MainCruise_ChangeLaneType_Parse(name, value);
  }
  ...
  bool has_change_lane_type() const;
  void clear_change_lane_type();
  ::apollo::planning::MainCruise_ChangeLaneType change_lane_type() const;
  void set_change_lane_type(::apollo::planning::MainCruise_ChangeLaneType value);
...
inline ::apollo::planning::MainStop_ChangeLaneType MainStop::change_lane_type() const {
  // @@protoc_insertion_point(field_get:apollo.planning.MainStop.change_lane_type)
  return static_cast< ::apollo::planning::MainStop_ChangeLaneType >(change_lane_type_);
}
inline void MainStop::set_change_lane_type(::apollo::planning::MainStop_ChangeLaneType value) {
  assert(::apollo::planning::MainStop_ChangeLaneType_IsValid(value));
  _has_bits_[0] |= 0x00000008u;
...
inline void MainEmergencyStop::clear_hard_brake() {
  if (hard_brake_ != nullptr) hard_brake_->Clear();
  _has_bits_[0] &= ~0x00000002u;
}
inline const ::apollo::planning::EmergencyStopHardBrake& MainEmergencyStop::hard_brake() const {
  const ::apollo::planning::EmergencyStopHardBrake* p = hard_brake_;
  // @@protoc_insertion_point(field_get:apollo.planning.MainEmergencyStop.hard_brake)
  return p != nullptr ? *p : *reinterpret_cast<const ::apollo::planning::EmergencyStopHardBrake*>(
      &::apollo::planning::_EmergencyStopHardBrake_default_instance_);
}
inline ::apollo::planning::EmergencyStopHardBrake* MainEmergencyStop::release_hard_brake() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  ::apollo::planning::EmergencyStopHardBrake* temp = hard_brake_;
  hard_brake_ = nullptr;
  return temp;
}
inline ::apollo::planning::EmergencyStopHardBrake* MainEmergencyStop::mutable_hard_brake() {
  _has_bits_[0] |= 0x00000002u;
  if (hard_brake_ == nullptr) {
    auto* p = CreateMaybeMessage<::apollo::planning::EmergencyStopHardBrake>(GetArenaNoVirtual());
    hard_brake_ = p;
  }
...
inline void MainEmergencyStop::clear_cruise_to_stop() {
  if (cruise_to_stop_ != nullptr) cruise_to_stop_->Clear();
  _has_bits_[0] &= ~0x00000004u;
}
inline const ::apollo::planning::EmergencyStopCruiseToStop& MainEmergencyStop::cruise_to_stop() const {
  const ::apollo::planning::EmergencyStopCruiseToStop* p = cruise_to_stop_;
  // @@protoc_insertion_point(field_get:apollo.planning.MainEmergencyStop.cruise_to_stop)
  return p != nullptr ? *p : *reinterpret_cast<const ::apollo::planning::EmergencyStopCruiseToStop*>(
      &::apollo::planning::_EmergencyStopCruiseToStop_default_instance_);
}
...
inline void MainEmergencyStop::set_allocated_cruise_to_stop(::apollo::planning::EmergencyStopCruiseToStop* cruise_to_stop) {
  ...
  cruise_to_stop_ = cruise_to_stop;
...
inline ::apollo::planning::MainCruise_ChangeLaneType MainCruise::change_lane_type() const {
  // @@protoc_insertion_point(field_get:apollo.planning.MainCruise.change_lane_type)
  return static_cast< ::apollo::planning::MainCruise_ChangeLaneType >(change_lane_type_);
}
inline void MainCruise::set_change_lane_type(::apollo::planning::MainCruise_ChangeLaneType value) {
  assert(::apollo::planning::MainCruise_ChangeLaneType_IsValid(value));
  _has_bits_[0] |= 0x00000001u;
  change_lane_type_ = value;
...
inline void MainDecision::clear_cruise() {
  if (cruise_ != nullptr) cruise_->Clear();
  _has_bits_[0] &= ~0x00000001u;
}
inline const ::apollo::planning::MainCruise& MainDecision::cruise() const {
  const ::apollo::planning::MainCruise* p = cruise_;
  // @@protoc_insertion_point(field_get:apollo.planning.MainDecision.cruise)
  return p != nullptr ? *p : *reinterpret_cast<const ::apollo::planning::MainCruise*>(
      &::apollo::planning::_MainCruise_default_instance_);
}
inline ::apollo::planning::MainCruise* MainDecision::release_cruise() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  ::apollo::planning::MainCruise* temp = cruise_;
  cruise_ = nullptr;
  return temp;
}
inline ::apollo::planning::MainCruise* MainDecision::mutable_cruise() {
  _has_bits_[0] |= 0x00000001u;
  if (cruise_ == nullptr) {
    auto* p = CreateMaybeMessage<::apollo::planning::MainCruise>(GetArenaNoVirtual());
    cruise_ = p;
  }
...
inline const ::apollo::planning::MainStop& MainDecision::stop() const {
  const ::apollo::planning::MainStop* p = stop_;
...
inline ::apollo::planning::MainStop* MainDecision::release_stop() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  ::apollo::planning::MainStop* temp = stop_;
  stop_ = nullptr;
  return temp;
}
...
inline const ::apollo::planning::MainEmergencyStop& MainDecision::estop() const {
  const ::apollo::planning::MainEmergencyStop* p = estop_;
  // @@protoc_insertion_point(field_get:apollo.planning.MainDecision.estop)
  return p != nullptr ? *p : *reinterpret_cast<const ::apollo::planning::MainEmergencyStop*>(
      &::apollo::planning::_MainEmergencyStop_default_instance_);
}
inline ::apollo::planning::MainEmergencyStop* MainDecision::release_estop() {
  ...
  _has_bits_[0] &= ~0x00000004u;
  ::apollo::planning::MainEmergencyStop* temp = estop_;
  estop_ = nullptr;
  return temp;
}
inline ::apollo::planning::MainEmergencyStop* MainDecision::mutable_estop() {
  _has_bits_[0] |= 0x00000004u;
  if (estop_ == nullptr) {
    auto* p = CreateMaybeMessage<::apollo::planning::MainEmergencyStop>(GetArenaNoVirtual());
    estop_ = p;
  }
...
inline const ::apollo::planning::MainChangeLane& MainDecision::change_lane() const {
  const ::apollo::planning::MainChangeLane* p = change_lane_;
  // @@protoc_insertion_point(field_get:apollo.planning.MainDecision.change_lane)
  return p != nullptr ? *p : *reinterpret_cast<const ::apollo::planning::MainChangeLane*>(
      &::apollo::planning::_MainChangeLane_default_instance_);
}
inline ::apollo::planning::MainChangeLane* MainDecision::release_change_lane() {
  ...
  _has_bits_[0] &= ~0x00000008u;
  ::apollo::planning::MainChangeLane* temp = change_lane_;
...
inline ::apollo::planning::MainChangeLane* MainDecision::mutable_change_lane() {
  ...
  if (change_lane_ == nullptr) {
    auto* p = CreateMaybeMessage<::apollo::planning::MainChangeLane>(GetArenaNoVirtual());
    change_lane_ = p;
  }
...
inline void MainDecision::clear_mission_complete() {
  if (mission_complete_ != nullptr) mission_complete_->Clear();
  _has_bits_[0] &= ~0x00000010u;
}
inline const ::apollo::planning::MainMissionComplete& MainDecision::mission_complete() const {
  const ::apollo::planning::MainMissionComplete* p = mission_complete_;
  // @@protoc_insertion_point(field_get:apollo.planning.MainDecision.mission_complete)
  return p != nullptr ? *p : *reinterpret_cast<const ::apollo::planning::MainMissionComplete*>(
      &::apollo::planning::_MainMissionComplete_default_instance_);
}
inline ::apollo::planning::MainMissionComplete* MainDecision::release_mission_complete() {
  ...
  _has_bits_[0] &= ~0x00000010u;
  ::apollo::planning::MainMissionComplete* temp = mission_complete_;
  mission_complete_ = nullptr;
  return temp;
}
inline ::apollo::planning::MainMissionComplete* MainDecision::mutable_mission_complete() {
  _has_bits_[0] |= 0x00000010u;
  if (mission_complete_ == nullptr) {
    auto* p = CreateMaybeMessage<::apollo::planning::MainMissionComplete>(GetArenaNoVirtual());
    mission_complete_ = p;
  }
...
inline void MainDecision::set_allocated_mission_complete(::apollo::planning::MainMissionComplete* mission_complete) {
  ...
  mission_complete_ = mission_complete;
...
inline void MainDecision::clear_not_ready() {
  if (not_ready_ != nullptr) not_ready_->Clear();
  _has_bits_[0] &= ~0x00000020u;
}
inline const ::apollo::planning::MainNotReady& MainDecision::not_ready() const {
  const ::apollo::planning::MainNotReady* p = not_ready_;
  // @@protoc_insertion_point(field_get:apollo.planning.MainDecision.not_ready)
  return p != nullptr ? *p : *reinterpret_cast<const ::apollo::planning::MainNotReady*>(
      &::apollo::planning::_MainNotReady_default_instance_);
}
inline ::apollo::planning::MainNotReady* MainDecision::release_not_ready() {
  ...
  _has_bits_[0] &= ~0x00000020u;
  ::apollo::planning::MainNotReady* temp = not_ready_;
  not_ready_ = nullptr;
  return temp;
}
inline ::apollo::planning::MainNotReady* MainDecision::mutable_not_ready() {
  _has_bits_[0] |= 0x00000020u;
  if (not_ready_ == nullptr) {
    auto* p = CreateMaybeMessage<::apollo::planning::MainNotReady>(GetArenaNoVirtual());
    not_ready_ = p;
  }
...
inline const ::apollo::planning::MainParking& MainDecision::parking() const {
  const ::apollo::planning::MainParking* p = parking_;
  // @@protoc_insertion_point(field_get:apollo.planning.MainDecision.parking)
  return p != nullptr ? *p : *reinterpret_cast<const ::apollo::planning::MainParking*>(
      &::apollo::planning::_MainParking_default_instance_);
}
inline ::apollo::planning::MainParking* MainDecision::release_parking() {
  ...
  _has_bits_[0] &= ~0x00000040u;
  ::apollo::planning::MainParking* temp = parking_;
  parking_ = nullptr;
  return temp;
}
inline ::apollo::planning::MainParking* MainDecision::mutable_parking() {
  _has_bits_[0] |= 0x00000040u;
  if (parking_ == nullptr) {
    auto* p = CreateMaybeMessage<::apollo::planning::MainParking>(GetArenaNoVirtual());
    parking_ = p;
  }
...
template <> struct is_proto_enum< ::apollo::planning::MainStop_ChangeLaneType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::apollo::planning::MainStop_ChangeLaneType>() {
  return ::apollo::planning::MainStop_ChangeLaneType_descriptor();
}
...
template <> struct is_proto_enum< ::apollo::planning::MainCruise_ChangeLaneType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::apollo::planning::MainCruise_ChangeLaneType>() {
  return ::apollo::planning::MainCruise_ChangeLaneType_descriptor();
}
