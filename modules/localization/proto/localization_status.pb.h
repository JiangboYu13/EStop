...
enum LocalLidarStatus : int {
  NORMAL = 0,
  MAP_MISSING = 1,
  EXTRINSICS_MISSING = 2,
  MAP_LOADING_FAILED = 3,
  NO_OUTPUT = 4,
  OUT_OF_MAP = 5,
  NOT_GOOD = 6,
  UNDEFINED_STATUS = 7
...
constexpr LocalLidarStatus LocalLidarStatus_MIN = NORMAL;
constexpr LocalLidarStatus LocalLidarStatus_MAX = UNDEFINED_STATUS;
...
constexpr LocalLidarConsistency LocalLidarConsistency_MIN = CONSISTENCY_00;
constexpr LocalLidarConsistency LocalLidarConsistency_MAX = CONSISTENCY_03;
